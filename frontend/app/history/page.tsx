    ...
    <AppShell>
      <div className="space-y-4">
        ...
        {!loading && !error && !items.length && (
          <p className="text-gray-400 text-sm">No history yet. Go synthesize something!</p>
        )}
            ...
            >
              <div className="space-y-1 min-w-0">
                <p className="text-sm truncate">
                  {item.textSnippet}{item.textSnippet.length === 100 ? "…" : ""}
                </p>
              ...
              <button
                ...
                className="shrink-0 px-3 py-1 rounded bg-violet-600 hover:bg-violet-700
